...
| Unknown and private URLs fell through to homepage HTML | Removed the catch-all SPA rewrite; retained explicit app/private rewrites and added `X-Robots-Tag: noindex, nofollow` to private routes | Preview: known URL 200, fabricated URL 404, `/auth` 200 with noindex/nofollow |
