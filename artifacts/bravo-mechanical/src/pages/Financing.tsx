...
const STEPS = [
  ...
  { icon: ShieldCheck, title: "We start the work", text: "Once you approve, we order equipment and schedule the install. Rebate paperwork (NYS Clean Heat, Con Edison) is handled alongside — those checks reduce your net cost either way." },
];
...
const FAQS = [
  ...
  { q: "Do rebates reduce what I need to finance?", a: "Often, yes. NYS Clean Heat, NYSERDA, and Con Edison incentives can take thousands off qualifying heat pump and high-efficiency equipment, and the federal 25C tax credit applies to many installs. We identify and file everything your project qualifies for." },
  ...
  return (
    <Layout>
      <PageHero
        ...
        subtitle="Financing options for qualified Westchester homeowners on heating and cooling replacements — with the written price fixed first, and every rebate handled to shrink the number."
      />
