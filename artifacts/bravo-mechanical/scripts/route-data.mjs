...
export const STATIC_ROUTES = [
  ...
  { path: "/emergency-hvac-westchester", changefreq: "weekly", priority: "0.95",
    ...
    title: "Emergency HVAC Repair in Westchester County, NY | Bravo Mechanical",
    description: "Emergency HVAC repair requests in Westchester County, NY. Safety-first next steps for no-heat and no-cool concerns. Call (914) 361-9142." },
